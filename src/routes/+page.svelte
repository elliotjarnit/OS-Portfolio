<div class="page">
  <div class="splash">
    <div class="loginpage">
      <img class="pfp" src="/pfp.jpeg" alt="profile picture" />
      <p>Elliot Jarnit</p>
      <input type="password" placeholder='Enter Password' value={passwordfieldval} class="passwordfield" on:keydown|preventDefault={void(0)} />
    </div>
  </div>
